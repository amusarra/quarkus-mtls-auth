...
class GovCertParserTest {
  ...
  @InjectMocks
  GovCertificateParser govCertificateParser;
  ...
  void parseValidCertificate() {
    ...
    govCertificateParser.parseAndSaveCerts(validXml);
  ...
  void parseInvalidCertificate() {
    ...
    govCertificateParser.parseAndSaveCerts(invalidXml);
  ...
  void parseCertificateWithMissingFields() {
    ...
    govCertificateParser.parseAndSaveCerts(missingFieldsXml);
  ...
  void parseCertificateWithInvalidSignature() {
    ...
    govCertificateParser.parseAndSaveCerts(invalidSignatureXml);
  ...
  void parseCertificateWithExpiredDate() {
    ...
    govCertificateParser.parseAndSaveCerts(expiredDateXml);
